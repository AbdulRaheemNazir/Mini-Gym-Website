...
$sql = "UPDATE customer SET username = :username, fname = :fname, lname = :lname, datebirth = :datebirth, email = :email, postcode = :postcode, password = :password WHERE username = :username2";

$stmt = $db->prepare($sql);

$stmt->bindParam(':username2',$_GET['username'], SQLITE3_TEXT); //discuss this!

$stmt->bindParam(':firstname',$_POST['firstname'], SQLITE3_TEXT);

$stmt->bindParam(':lastname',$_POST['lastname'], SQLITE3_TEXT); //discuss this!
...
<input class="form-control" type="text" name = "firstname" value="<?php echo $arrayResult[0][1]; ?>">
...
<input class="form-control" type="text" name = "lastname" value="<?php echo $arrayResult[0][2]; ?>">
...
<div class="form-group col-md-3"><a href="userindex.php">Back</a></div>
